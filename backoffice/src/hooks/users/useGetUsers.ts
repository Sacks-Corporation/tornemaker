...
// usuarios. `page`/`pageSize`/`sortField`/`sortDirection` viajan en el
// `queryKey` para que cada combinación tenga su propia entrada de cache.
...
export function useGetUsers(
  ...
  return useQuery({
    queryKey: [USERS_QUERY_KEY, page, pageSize, sortField, sortDirection],
    queryFn: () => getUsers(page, pageSize as number, sortField, sortDirection),
